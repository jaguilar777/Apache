...
This repo will give you a turn key Docker container build for use in production OR local development. The setup includes an Apache web service, PHP 5.5.9, PHP Composer, linked MySQL instance and a data container volume.
